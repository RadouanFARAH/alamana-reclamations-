...
const Crud = () => {
    ...
    const [userCo, setUserCo] = useState(localStorage.getItem("role") || null);
    ...
    const relancerBodyTemplate = (rowData) => {
        return (
            <>
                <span className="p-column-title">Remarque</span>
                {rowData.relancer || <i className="pi pi-spin pi-spinner" style={{ fontSize: "2em" }}></i>}
            </>
        );
    };
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="actions">
                <Button label="Traiter" icon="pi pi-check" className="p-button-rounded p-button-success mr-2" onClick={() => editProduct(rowData)} />
                {(userCo === "ca" || userCo === "gs") && <Button label="Affecter" icon="pi pi-check" className="p-button-rounded p-button-echec mr-2" onClick={() => confirmDeleteProduct(rowData)} />}
            </div>
        );
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >  
                        ...
                        <Column field="relancer" header="Traitement relancer" body={relancerBodyTemplate} sortable headerStyle={{ width: "14%", minWidth: "8rem" }}></Column>
                    ...
                    <h5><b style={{color:"black"}}>Détails Réclamation :</b>   </h5> 
                        <div className="formgrid grid">
                            ...
                            <div className="field col">
                                <label htmlFor="utilisateur"   ><b>Utilisateur :</b> </label>
                        ...
                        <div className="formgrid grid">
                        <div className="field col">    
                            <label htmlFor="type"   ><b>Calification :</b></label>
                        ...
                        <div className="field col" >
                            ...
                            <div className="field col">
                                <label htmlFor="sous-type"   ><b>date d'affectation :</b></label>
                        ...
                        <div className="formgrid grid">
                        <div className="field col">
                                <label htmlFor="relancer"   ><b>Traitement relancer :</b></label>
                                <p>{(product.relancer)}</p>
                            </div>
                        </div> 
...
<hr></hr>
                    ...
                    <Dialog visible={deleteProductDialog} style={{ width: "550px" }} header="Confirm" modal footer={deleteProductDialogFooter} onHide={hideDeleteProductDialog}>
                        ...
                        <div className="formgrid grid">
                            <div className="field col">
                                <Dropdown
                                    ...
                                    style={{ marginRight: "20px", width: "295px", marginLeft: "8px" }}
                                />
                            </div>
                            {userSelected && (
                            <div className="formgrid grid">
